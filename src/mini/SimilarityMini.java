...
public class SimilarityMini {
	...
	public static int totalNumDocs;
	...
	public static HashMap<String, HashMap<String, Integer>> docTermFreqMap = new HashMap<String, HashMap<String, Integer>>();
	public static HashMap<String, Integer> invDocFreqMap = new HashMap<String, Integer>();
	public static HashMap<String, Integer> maxTfMap = new HashMap<String, Integer>();
	public static HashMap<Integer, Integer> maxQueryTfMap = new HashMap<Integer, Integer>();
	public static HashMap<Integer, TreeMap<String, Integer>> queryMap = new HashMap<Integer, TreeMap<String, Integer>>();
	public static HashMap<String, HashSet<String>> idfMap = new HashMap<String, HashSet<String>>();
	public static HashMap<Integer, HashMap<String, Double>> queryRelMap = new HashMap<Integer, HashMap<String, Double>>();
	...
	public static void main(String[] args) {
		initMed();
		printMapPartAMed(100, "nonverbose", null);
	}
